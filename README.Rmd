...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/arkhaia)](https://CRAN.R-project.org/package=arkhaia)
<!-- badges: end -->
...
To obtain the current development version of the package, `devtools` can be used to install `arkhaia` from GitHub:
